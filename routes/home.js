...
router.route("/").get(async (req, res) => {
 ...
 req.session.pageNow = '/';
 if(req.session.user){
  res.render('homepage',{userName: req.session.user.userName,title:"Homepage",isPark: true, hideTitle: true});
 }else{
...
router.route("/AK").get(async (req, res) => {
  ...
  res.status(200).render('../views/parkstate',{park: park_state,title:"Alaska"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/OR").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Oregon"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/WA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Washington"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/CA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"California"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/UT").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Utah"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/TX").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Texas"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NM").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"New Mexico"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/AZ").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Arizona"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NV").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Nevada"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/CO").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Colorado"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/WY").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Wyoming"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MT").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Montana"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/ME").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Maine"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/SD").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"South Dakota"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/OH").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Ohio"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/SC").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"South Carolina"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MO").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Missouri"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/AR").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Arkansas"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/IN").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Indiana"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MI").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Michigan"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/ND").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"North Dakota"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MN").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Minnesota"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/FL").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Florida"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/TN").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Tennessee"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/KY").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"Kentucky"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/WV").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  res.status(200).render('../views/parkstate',{park: park_state,title:"West Virginia"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/ID").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Idaho"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Idaho"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NE").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Nebraska"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Nebraska"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/KS").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Kansas"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Kansas"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/OK").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Oklahoma"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Oklahoma"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/IA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Iowa"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Iowa"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/LA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Louisiana"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Louisiana"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/WI").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Wisconsin"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Wisconsin"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/IL").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Illinois"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Illinois"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MS").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Mississippi"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Mississippi"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/AL").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Alabama"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Alabama"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/GA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Georgia"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Georgia"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/PA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Pennsylvania"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Pennsylvania"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NC").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"North Carolina"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"North Carolina"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MD").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Maryland"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Maryland"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/VA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Virginia"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Virginia"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NY").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"New York"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"New York"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NJ").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"New Jersy"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"New Jersy"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/DE").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Delaware"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Delaware"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/DC").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"DC"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"DC"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/VT").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Vermont"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Vermont"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/NH").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"New Hampshire"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"New Hampshire"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MA").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Massachusettes"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Massachusettes"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/CT").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Connecticut"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Connecticut"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/RI").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Rhode Island"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Rhode Island"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/VI").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"US Virgin Islands"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"US Virgin Islands"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/PR").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Puerto Rico"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Puerto Rico"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/GU").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Guam"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Guam"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/MP").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"Northern Mariana Islands"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"Northern Mariana Islands"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
...
router.route("/AS").get(async (req, res) => {
  ...
  park_state = await getorigin(park_state,req);
  if(park_state==0){
    res.status(200).render('../views/noparkstate',{title:"American Samoa"});
    return;
  }
  res.status(200).render('../views/parkstate',{park: park_state,title:"American Samoa"});
}catch(e){
  res.status(500).render('error', {title: 'Error Page', path: '/homepage', statuscode: 500, error: 'failed to fetch data' });
  return;
  }
