...
router.route("/user/results").get(async (req, res) => {
  ...
  try {
    ...
    res.status(200).render('rankUsers', {title:"User rank",option: option, itemsNum: itemsNum, reverse: reverse, results: results})
    return
  } catch (e) {
...
router.route("/review/results").get(async (req, res) => {
  ...
  try {
    ...
    res.render('rankReviews', {title:"Review rank",option: option, itemsNum: itemsNum, reverse: reverse, results: results})
    res.status(200)
    return
  } catch (e) {
...
router.route("/park/results").get(async (req, res) => {
  ...
  try {
    ...
    res.render('rankParks', {title:"Park rank", option: option, reverse: reverse, results: results})
    res.status(200)
    return
  } catch (e) {
